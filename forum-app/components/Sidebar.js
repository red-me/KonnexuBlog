        ...
        <Card className="h-[calc(100vh-2rem)] w-full max-w-[20rem] p-0 shadow-xl shadow-blue-gray-900/5">
            <div className='px-4 py-6 w-full'>
                <Button
                    ...
                    className={`${theme.data.button_primary.className} w-full flex items-center gap-2 justify-center capitalize text-lg`}
                    onClick={handleClick}
                >
                    <span className='text-2xl'>+</span> Create New Thread
                </Button>
            </div>
