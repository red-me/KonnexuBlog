...
const SimpleFileUploadComponent = (props) => {

    const { fileUrls, setFileUrls, isBusy, path } = props;
    ...
    const layoutComponent = (props) => {
        ...
        return (
            <div {...dropzoneProps} title='drag & drop here' className='flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg  bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600'>
                {input}
