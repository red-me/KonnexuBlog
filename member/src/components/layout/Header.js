...
function Header() {
    ...
    return (
        <header className={theme.data.header.className} style={theme.data.header.style}>
            <div className={theme.data.header_list.className} style={theme.data.header_list.style}>
                <div className=" w-full  flex items-center justify-between px-2">
                    <div className="flex items-center gap-x-1  justify-start">
                        ...
                        >
                            <Link href='/' className="items-center w-44"><img className="h-[32px] mr-2 inline-block" src={`${brandLogoUrl || '/xmindlogo.png'}  `} alt="logo" /></Link>
            ...
            <span>{user && user.email}</span>
                        ...
                        <div className="flex gap-2 ">
                            ...
                            <div className="p-2 cursor-pointer hover:-translate-y-1 transition-all duration-300 ">
