...
export default function ProfileMenu({ user, logout }) {
    ...
    return (<>
        {user ? (<Menu placement="bottom-end" >
            ...
            <MenuList className="p-0 m-0 w-80 border-0 rounded-tr-none shadow-m shadow-gray-600">
                <Link href={user.name ? `/${user.name}` : `/user/${user.id}`}>
                    <div className="cursor-pointer h-28 pt-12 bg-gradient-to-b outline-none from-gray-300  to-gray-900 px-3"  >
                        <Typography variant="lead" className="font-bold text-white uppercase">
                ...
                <MenuItem className="flex items-center gap-2 rounded-none" onClick={(e) => { e.preventDefault(); router.push('/user/settings'); return false; }}>
                    <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
                ...
                {user.userGroup && user.userGroup.name == "Administrator" &&
                    <MenuItem className="flex items-center gap-2 rounded-none" onClick={() => { router.push('/admincp') }}>
                ...
                <hr className="my-2 border-blue-gray-50" />
                <MenuItem className="flex items-center gap-2  rounded-none" onClick={() => { logout() }}>
                    <svg
                        width="16"
                        height="14"
                        viewBox="0 0 16 14"
