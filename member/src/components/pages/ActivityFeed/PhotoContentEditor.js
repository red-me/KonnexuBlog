...
const PhotoContentEditor = (props) => {
    ...
    const { postContent, setPostContent, isCreatingPost, path } = props;
    ...
    return (
        <FileUploadComponent fileUrls={imageUrls} setFileUrls={setImageUrls} isBusy={isCreatingPost} path={path}></FileUploadComponent>
    );
};
