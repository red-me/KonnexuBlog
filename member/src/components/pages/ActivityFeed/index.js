...
export default function ActivityFeed() {
    ...
    const { activities, isLoading, create, isCreatingPost } = useContext(PostContext)
    ...
    return (<>
        ...
        {user && <div className="mx-auto w-full max-w-screen-xl"> <div className="flex flex-1 justify-center mt-2">
            <div className="flex flex-1  ">
                <div className="block w-full h-fit overflow-y-hidden">


                    <div className="flex ">
                        <div className="flex-1 w-full  p-1 justify-end">
                        ...
                        <div className="shrink-0 md:w-1/2  p-1" >
                            <Card className="w-full rounded-md">
                                ...
                                <CardBody className="p-0 m-0">
                                    {activeTab == "photo" && <PhotoContentEditor path={photoPath} postContent={postContent} setPostContent={setPostContent} isCreatingPost={isCreatingPost} />}
                                ...
                                <CardFooter className=' p-2 m-0 rounded-md rounded-t-none content-between border-t' >
                                    <div className="flex  flex-wrap">
                                        ...
                                        <div className="w-full md:w-1/2  p-0 justify-end flex "><Button loading={isCreatingPost} type="button" onClick={() => submitPost()} className={theme.data.button_primary.className} style={theme.data.button_primary.style}>Share</Button></div>
                        ...
                        <div className="flex-1 w-full   p-1 "><Card className="p-2 rounded-md max-w-md">
                            right</Card></div>
                    </div>
