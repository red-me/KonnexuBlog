...
export default function NavBarPreview(props) {
  ...
  const { user, initialLoading, statusText, logout } = useContext(AdminAuthContext)



  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 uppercase font-extrabold ">
      <Typography
        as="li"
        variant="small"
      ...
      >
        ...
        <Link href="#" className="flex items-center   transition-all duration-1000" style={itemTextStyle}>
          HelloApp
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link
          href="#" className="flex items-center  transition-all duration-1000" style={itemTextStyle}>
          Photos
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link href="#" className="flex items-center gap-x-2 p-1 font-medium  transition-all duration-300 opacity-75 hover:opacity-100" style={itemTextStyle}>
          App Tester
        </Link>
  ...
  return (<>
    ...
    <div className={`transition-all duration-1000 ${navClassName}`} style={navStyle}>
      <div className={` w-full  flex items-center justify-around px-2  scale-75`} >
      ...
      <Collapse open={openNav}>
        <div className="container mx-auto  scale-75">
          {navList}
