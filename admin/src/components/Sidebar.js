...
export default function Sidebar() {
  ...
  const { sideBarOpen, activeIndex, setActiveIndex, activeSubIndex, setActiveSubIndex, activeIndexes, setActiveIndexes } = useContext(SidebarContext)
  ...
  const menu = [
    ...
    },
    {
      ...
      children: [
        { itemIndex: 201, label: "Installed", url: '/apps/installed' },
        { itemIndex: 202, label: "Active", url: '/apps/active' },
        { itemIndex: 203, label: "Available", url: '/apps/available' }
      ]
    },
    {
      itemIndex: 3,
      ...
      icon: "PaintBrushIcon",
      children: [
        { itemIndex: 301, label: "Themes", url: '/appearance/themes' },
        { itemIndex: 302, label: "Blocks", url: '/appearance/blocks' },
        { itemIndex: 303, label: "Pages", url: '/appearance/pages' }
      ]
    },
    {
      itemIndex: 4,
  ...
  const MenuItemSingleAction = ({ itemIndex, label, icon, action }) => {
    ...
    return <ListItem onClick={() => { action() }} className="font-normal text-sm " >
      <ListItemPrefix>
        <Suspense fallback={loader}>
  ...
  const MenuListItems = () => {
    return <List className="p-0 gap-0">{menu.map(item => {
      ...
      else if (item.url) return <MenuItemSingleUrl {...item} ></MenuItemSingleUrl>
