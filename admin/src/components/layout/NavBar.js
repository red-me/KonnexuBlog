...
export default function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <Link href="/app/HelloApp" className="flex items-center">
          HelloApp
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link
          href="/app/Photos" className="flex items-center">
          Photos
        </Link>
      </Typography>
      <Typography
  ...
  return (<>
    ...
    <div className="mx-auto w-full px-4 py-2 lg:px-8 lg:py-2 max-w-screen-xl">
      <div className="container mx-auto flex items-center justify-between text-black">
        <Typography

          className="mr-4 cursor-pointer py-1.5 font-medium "
        >
          <Link href='/' className="items-center  text-black-900 dark:text-white w-44"><img className="w-6 h-6 mr-2 inline-block" src="/xmindlogo.png" alt="logo" /> Konnexu Home</Link>
