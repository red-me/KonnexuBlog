        ...
        <div className='p-4 bg-gray-100 dark:bg-gray-900'>
            ...
            {photosShort.length > 4 && <><div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                ...
                > <div class="w-full h-full  relative ">
                        ...
                        <div class="absolute bottom-0 right-0  h-40 px-4 py-3 bg-gray-500/80 w-full rounded-lg">
                            <h1 class="text-white font-semibold text-4xl absolute bottom-1/3 right-1/3 ">  +{photos.length - photosShort.length}</h1>
                            ...
                            {photos.map((photo, index) => {
                                ...
                                return <>
                                    ...
                                    <div class="w-full h-full  relative">
                                        ...
                                        {(title.length > 0 || description.length > 0) && <div class="absolute bottom-0 px-4 py-3 bg-gray-500/50 w-full">
